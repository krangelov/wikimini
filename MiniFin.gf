...
lin north_america_1_PN = mkPN "Pohjois-Amerikka" ;
...
lin asia_2_PN = mkPN "Aasia" ;

lin adriatic_sea_PN = mkPN (mkN "Adrian" (mkN "meri" "meren" "meriä" "merta")) ;
lin balkans_2_PN = mkPN "Balkan" ;
lin greenland_PN = mkPN "Grönlanti" ;
lin haida_N = mkN "haida" ;
lin middle_east_9_PN = mkPN "Lähi-Itä" ;
...
lin finland_PN = mkPN (mkN "Suomi" "Suomia") ;
...
lin pyongyang_PN = mkPN "Pjongjang" ;
